...
def main_menu(screen, screen_width, screen_height, moon_image, earth_image, player_image):

    def start_game():
        win = main.mainGame(screen, screen_width, screen_height, moon_image, earth_image, player_image)
        if win != None:
