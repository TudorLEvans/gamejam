...
class Player(pygame.sprite.Sprite):
    def __init__(self, screen_width, screen_height, player_image):
        ...
        self.collision_shape = pymunk.Circle(self.body, radius=self.height)
        self.collision_shape.mass = 1
    ...
    @property
    def topleft(self):
        return self.body.position + pymunk.Vec2d(self.width // 2, self.height // 2)
