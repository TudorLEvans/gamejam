...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, screen_width, screen_height):
        ...
        self.thrust_magnitude, self.thrust_direction = 2, 1
    ...
    def update(self):
        ...
        if self.rect.right >= self.screen_width and self.thrust_direction == 1:
            self.thrust_direction *= -1
        elif self.rect.left <= 0 and self.thrust_direction == -1:
            self.thrust_direction *= -1
